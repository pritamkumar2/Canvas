      ...
      <div className="py-11">
        ...
        <div className="grid grid-cols-2 mt-5 gap-y-5 sm:gap-y-0 lg:mx-auto lg:max-w-4xl">
          ...
          <div className="col-span-2 px-3 pb-3 dark:border-slate-700 border-gray-50 sm:col-span-1 sm:flex sm:flex-col sm:justify-center sm:pl-7 sm:border-t lg:border-r">
            ...
            <p className="text-base font-normal tracking-tight leading-relaxed dark:divide-undefined dark:text-gray-300">
          ...
          <div className="grid -mx-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="px-4">
              <div className="py-6">
                ...
                <h5 className="text-black text-lg font-semibold dark:text-white">
                  Reusable Components
                </h5>
                <p className="text-sm">
