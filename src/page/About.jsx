    ...
    <div>
      <div class="py-11">
        <div class="text-center flex flex-col gap-y-3 px-2 sm:mx-auto sm:max-w-xl">
          <p class="dark:text-gray-300">Get Started</p>
          <h1 class="font-bold text-3xl text-slate-900 dark:text-gray-100 sm:text-4xl">
            Let&#x27;s show the world
          </h1>
          <p class="text-base dark:text-gray-400 sm:text-lg">
        ...
        <div class="grid grid-cols-2 mt-5 gap-y-5 sm:gap-y-0 lg:mx-auto lg:max-w-4xl">
          ...
          <div class="col-span-2 px-3 pb-3 dark:border-slate-700 border-gray-50 sm:col-span-1 sm:flex sm:flex-col sm:justify-center sm:pl-7 sm:border-t lg:border-r">
            <h1 class="font-semibold text-gray-700 tracking-tight text-xl dark:text-gray-200 dark:divide-undefined sm:mb-2 md:my-1">
              Transfer Money
            </h1>
            <p class="text-base font-normal tracking-tight leading-relaxed dark:divide-undefined dark:text-gray-300">
              Far far away, behind the word mountains, far from the countries
              Vokalia and Consonantia, there live the blind texts. Separated
              they live in Bookmarksgrove right at the coast of the Semantics,
            </p>
          </div>
          <div class="col-span-2 px-3 pb-3 order-3 dark:border-slate-700 border-gray-50 sm:col-span-1 sm:flex sm:flex-col sm:justify-center sm:pl-7 sm:order-none sm:border-b lg:border-l">
            <h1 class="font-semibold text-gray-700 tracking-tight text-xl dark:text-gray-200 dark:divide-undefined sm:mb-2 md:my-1">
              Credit Card Payment
            </h1>
            <p class="text-base font-normal tracking-tight leading-relaxed dark:divide-undefined dark:text-gray-300">
          ...
          <div class="col-span-2 order-2 sm:col-span-1 sm:order-none">
            <img
              class="w-full bg-gray-50"
              alt="No alt"
              src="https://picsum.photos/300"
      ...
      <div class="">
        <div class="text-center px-3 py-16 max-w-7xl mx-auto">
          <h1 class="font-black tracking-tight text-slate-900 text-3xl dark:text-slate-100 sm:text-4xl">
            We work as a Team!
          </h1>
          <p class="mt-3 text-lg max-w-lg mx-auto">
            Start growing in half the time with an all-in-one website builder -
            no more long hours spent on the boring stuff!
          </p>
          <div class="grid gap-2 mt-12 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div class="text-center">
              <img
                class="rounded-full w-60 mx-auto mb-4 bg-blue-100"
                alt="No alt"
                src="https://images.pexels.com/photos/9968247/pexels-photo-9968247.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"
              />
              <h1 class="text-2xl font-bold dark:text-slate-200 text-slate-800">
                John Doe
              </h1>
              <p class="">CEO  &amp; CTO</p>
            </div>
      ...
      <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div class="max-w-lg space-y-3 sm:mx-auto lg:max-w-xl">
          <div class="flex items-center p-2 transition-colors duration-200 border shadow group hover:bg-primary-500 hover:border-primary-500 rounded-global">
            <div class="mr-2">
              <span class="w-6 h-6 transition-colors duration-200 group-hover:text-white text-primary-500 sm:w-8 sm:h-8">
                <svg
                  class="w-6 h-6 transition-colors duration-200 group-hover:text-white text-primary-500 sm:w-8 sm:h-8"
                  stroke="currentColor"
                  viewBox="0 0 52 52"
                >
                  <polygon
          ...
          <div class="flex items-center p-2 transition-colors duration-200 border shadow group hover:border-primary-500 hover:bg-primary-500 rounded-global">
            <div class="mr-2">
              <span class="w-6 h-6 transition-colors duration-200 group-hover:text-white text-primary-500 sm:w-8 sm:h-8">
                <svg
                  class="w-6 h-6 transition-colors duration-200 group-hover:text-white text-primary-500 sm:w-8 sm:h-8"
      ...
      <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="mx-auto sm:text-center lg:max-w-2xl">
          <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <div class="">
              <p class="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider uppercase rounded-full bg-secondary text-white">
                {" "}
                New Store
              </p>
            </div>
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-slate-900 dark:text-slate-100 sm:text-4xl md:mx-auto">
          ...
          <div class="mb-4 lg:mb-6">
            <img
              class="object-cover w-full h-56 rounded sm:h-64 md:h-80 lg:h-96 lg:object-contain"
              alt="No alt"
          ...
          <p class="max-w-xl mb-4 text-base sm:mx-auto">
            {" "}
          ...
          <a
            class="inline-flex items-center font-semibold transition-colors duration-200 text-secondary hover:text-secondary-800"
            href="#"
          >
            <span class=""> Learn more </span>
            <span class="inline-block w-3 ml-2">
              <svg
      ...
      <div class="py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div class="mb-10 md:mb-16">
            <h2 class="font-bold text-center mb-4 text-3xl text-slate-900 dark:text-slate-100 md:mb-6 lg:text-4xl">
          ...
          <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-12 xl:gap-16">
            <div class="flex flex-col items-center">
              ...
              <a
                class="font-bold transition duration-100 text-primary hover:text-primary-700 active:text-primary-700"
                href="#"
              >
                More
              </a>
      ...
      <div class="">
        <div class="mx-auto px-4 max-w-7xl">
          <div class="grid -mx-4 sm:grid-cols-2 lg:grid-cols-4">
            <div class="px-4">
              <div class="py-6">
                <h3 class="text-primary-500 text-4xl font-bold lg:mb-4">50+</h3>
                <h5 class="text-black text-lg font-semibold dark:text-white">
                  Reusable Components
                </h5>
                <p class="text-sm">
            ...
            <div class="px-4">
              <div class="py-6">
                <h3 class="text-primary-500 text-4xl font-bold lg:mb-4">54%</h3>
                <h5 class="text-black text-lg font-semibold dark:text-white">
                  Fully Customizable
                </h5>
                <p class="text-sm">
            ...
            <div class="px-4">
              <div class="py-6">
                <h3 class="text-primary-500 text-4xl font-bold lg:mb-4">24</h3>
                <h5 class="text-black text-lg font-semibold dark:text-white">
                  Dark Mode Support
                </h5>
                <p class="text-sm">
            ...
            <div class="px-4">
              <div class="py-6">
                <h3 class="text-primary-500 text-4xl font-bold lg:mb-4">
                  100%
                </h3>
                <h5 class="text-black text-lg font-semibold dark:text-white">
                  Export Code
